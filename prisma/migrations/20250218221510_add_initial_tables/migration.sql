-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'IN_PREPARING', 'IN_DELIVERY', 'FINISHED');

-- CreateEnum
CREATE TYPE "ConsumptionMode" AS ENUM ('TAKEAWAY', 'DINE_IN');
...
CREATE TABLE "OrderProduct" (
    ...
    "priece" DOUBLE PRECISION NOT NULL,
    "createAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updateAt" TIMESTAMP(3) NOT NULL,
